...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
                <div class="panel-heading"><h1>Opleiding</h1></div>
                       <table class="table">
                        <thead>
                            <tr>
                            <th><b>Opleidingsnaam</b></th>
                        ...
                        <!-- 11-05-2017 Lars: Voor iedere student wordt er een foreach loop gemaakt doordoor de tabel meerdere resultaten kan tonen --> 
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('Opleiding.edit', $opleiding->id)}}" class="btn btn-warning">Wijzigen</a>
                            </td>
                            <td>

                                {!! Form::open(['method'=>'delete', 'route'=>['Opleiding.destroy', $opleiding->id]])!!}
            ...
            <button class="btn btn-primary" style="width:80px;height:35px"> <a href="/Opleiding/create"><b style=""><span class="glyphicon glyphicon-plus" style="color:white;font-size: 20px;"></span></b></a></button>
        </div>
    </div>
@endsection
