...
class CoachController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Coach')->with('message', 'Coach is succesvol aangemaakt!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Coach.edit', compact('coaches'));
    }
    ...
    {
        Coach::find($request->all());
        $coaches = Coach::find($id);
        $CoachUpdate = $request->all();
        $coaches->update($CoachUpdate);
        return redirect('Coach')->with('message', 'Coach is succesvol gewijzigd!');
    }
